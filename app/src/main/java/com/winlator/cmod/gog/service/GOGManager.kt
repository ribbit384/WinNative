...
import com.winlator.cmod.gog.data.GOGCloudSavesLocationTemplate
...
import com.winlator.cmod.gog.db.dao.GOGGameDao
...
import com.winlator.cmod.core.FileUtils as WinlatorFileUtils
...
class GOGManager @Inject constructor(
        ...
        return withContext(Dispatchers.IO) {
            try {
                ...
                com.winlator.cmod.PluviaApp.events.emitJava(
                    com.winlator.cmod.steam.events.AndroidEvent.LibraryInstallStatusChanged(libraryItem.gameId),
                )
    ...
    fun getGogWineStartCommand(
        ...
        val executablePath = if (configuredExecutablePath.isNotEmpty()) {
